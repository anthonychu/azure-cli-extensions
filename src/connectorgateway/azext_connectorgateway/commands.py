from azext_connectorgateway._transformers import (
...
def load_command_table(self, _):
    with self.command_group('connectorgateway') as g:
    ...
    with self.command_group('connectorgateway available-connector') as g:
    ...
    with self.command_group('connectorgateway connection') as g:
    ...
    with self.command_group('connectorgateway connection access-policy') as g:
    ...
    with self.command_group('connectorgateway mcp-server-config') as g:
    ...
    with self.command_group('connectorgateway trigger-config') as g:
